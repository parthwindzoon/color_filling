      ...
      children: [
        ...
        Align(
          ...
          child: Container(
            width: 120,
            height: Get.height,
            decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/images/tools_bg.png'), fit: BoxFit.fill)),
            child: Column(
              ...
              children: [
                ...
                _buildToolButton(imagePath: 'assets/images/brush.png', onTap: controller.toggleBrush, isBrush: true),
                ...
                _buildToolButton(imagePath: 'assets/images/eraser.png', onTap: controller.toggleEraser, isBrush: false),
              ],
            ),
          ),
        ),
